...
- **レイヤー分離（Handler / Repository / Model / Database）:** 責務の分離を意識したディレクトリ構成。
...
- [x] Docker対応- 2026/06/24実装完了
- [x] Todo CRUD API (GET/POST/PUT/DELETE)をDB対応 - 2026/06/27実装完了
- [x] User signup + bcrypt対応（password hashing） - 2026/06/30
